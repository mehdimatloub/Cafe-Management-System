...
@NamedQuery(name ="Product.getProductById",query = "select new com.example.cafe.wrapper.ProductWrapper(p.id,p.name,p.description,p.price)from Product p where p.id=:id")
@Data
@Entity
@DynamicInsert
@DynamicUpdate
